...
int main()
{
	...
	auto func1 = [number](int a) { return a + number; };
	auto func2 = [&number, value]() { number *= value; };

	auto func3 = [=, &number]() { std::cout << number++ << " - " << value << std::endl; }; // by value
	auto func4 = [&]() { std::cout << number++ << " - " << value << std::endl; }; // by reference
